...
// node_modules/.pnpm/redux-database@0.0.20/node_modules/redux-database/dist/index.esm.js
...
function compact(items) {
  return items.filter((e) => e !== void 0);
}
...
function orderBy(elements, key) {
  var order2 = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : "asc";
...
var Table = class {
  ...
  changesFor(id) {
    ...
    var changes = changeSets.length > 0 ? changeSets.reduce((obj, change) => Object.assign({}, obj, change), {}) : void 0;
    return {
      id,
      deleted,
      inserted,
...
var Query = class _Query {
  ...
  embed(key, table, source) {
    var results = this.all.map((e) => {
      var embed = e[source] ? this.db.table(table).find(e[source]) : void 0;
  ...
  queryFromResults(results) {
    ...
    return new _Query(this.db, table);
  }
};
var DB = class _DB {
  /**
   ...
   */
  table(type) {
    var contextChanges = this.currentContext ? this.changeSetsOfContext(type, this.currentContext) : void 0;
  ...
  switch (action.type) {
    case "INSERT_RECORD": {
      ...
      if (action.payload.context) {
        state = applyInContext(state, action.payload.context, key, (changes2) => {
          return _objectSpread2(_objectSpread2({}, changes2), {}, {
            newIds: [...changes2.newIds, ...newIDs],
            byId: _objectSpread2(_objectSpread2({}, changes2.byId), byId(action.payload.data))
          });
        });
      } else {
    ...
    case "DELETE_RECORD": {
      ...
      if (action.payload.context) {
        state = applyInContext(state, action.payload.context, _key2, (changes2) => {
          return _objectSpread2(_objectSpread2({}, changes2), {}, {
            deletedIds: [...changes2.deletedIds, ...ids]
          });
        });
      } else {
    ...
    case "UPDATE_RECORD": {
      ...
      if (action.payload.context) {
        state = applyInContext(state, action.payload.context, _key3, (changes2) => {
          var updates2 = {};
          action.payload.ids.forEach((e) => updates2[e] = _objectSpread2(_objectSpread2({}, changes2.byId[e]), action.payload.data));
          return _objectSpread2(_objectSpread2({}, changes2), {}, {
            byId: _objectSpread2(_objectSpread2({}, changes2.byId), updates2)
          });
        });
      } else {
...
var MutableDB = class _MutableDB {
  constructor(state) {
    var options = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    this.state = state;
    this.currentContext = options.context;
  ...
  context(context) {
    return new _MutableDB(this.state, {
      context,
      store: this.store
    });
  }
...
//# sourceMappingURL=redux-database.js.map
